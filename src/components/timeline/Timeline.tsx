...
export function Timeline(props: TimelineProps) {
  const {
    ...
    commitTimelineSelectionMove, zoom, setZoom, px, trackScale, setTrackScale, metaOf,
  ...
  return (
    ...
    >
      ...
      <TimelineToolbar
        ...
        trackScale={trackScale} setTrackScale={setTrackScale}
      />
      ...
      <div ref={scrollRef} className="cc-timeline-scroll" style={{ overflow: 'auto', flex: 1, minHeight: 0 }}
...
The playhead line/triangle is pointerEvents:none, click it to click the ruler - scrub the same path to take effect.*/}
          ...
          {trackIds.map((trackId) => {
            ...
            return (
              <div key={trackId} className="cc-track-row" data-track-kind={meta.kind} style={{ height: rowHeightOf(trackId), background: isDropTarget ? `color-mix(in srgb, ${theme.success} 15%, ${theme.bg})` : undefined }}>
                <TrackHead
