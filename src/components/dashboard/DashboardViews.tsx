  ...
  return (
    <main style={{ flex: 1, minHeight: 0, overflowY: 'auto' }}>
      <div style={{ maxWidth: 1120, margin: '0 auto', padding: '28px 24px 80px' }}>
        <section style={{ marginBottom: 18, padding: '18px 20px', border: '1px solid rgba(216,180,90,.32)', borderRadius: 10, background: 'linear-gradient(120deg, rgba(216,180,90,.10), rgba(121,216,139,.05))' }}>
          <span style={{ color: theme.accent, fontSize: 10, fontWeight: 800, letterSpacing: '.14em' }}>KAKA CUT · LOCAL E EDITÁVEL</span>
          <h2 style={{ margin: '7px 0 5px', color: theme.textStrong, fontSize: 18 }}>Comece um projeto e coloque suas mídias livremente.</h2>
          <p style={{ margin: 0, maxWidth: 780, color: theme.textDim, fontSize: 12.5, lineHeight: 1.6 }}>Escolha a pasta do episódio: o Kaka Cut encontra o SRT, organiza as mídias numeradas e mostra uma prévia antes de criar uma timeline totalmente editável.</p>
        </section>
