...
const GRAPHITE: SkinTokens = {
  bg: '#0d0914', inset: '#120c1c', panel: '#171020', panelAlt: '#21172d', hover: '#30213f',
  border: '#3b2a4c', borderLight: '#58406d',
  text: '#eee8f5', textMuted: '#c2b5cf', textDim: '#8d7d9b', textStrong: '#ffffff',
  accent: '#a855f7', accentDeep: '#7e22ce', accentRgb: '168,85,247', onAccent: '#ffffff',
  inkRgb: '255,255,255', shadowRgb: '0,0,0', colorScheme: 'dark',
  gold: '#f0b95d', select: '#c084fc', success: '#4fbd83', danger: '#ee6f8b',
  tlTrack: '#181120', tlSidePanel: '#130d1b',
  trackVideo: '#7c3aed', trackAudioA1: '#c069e8', trackAudioA2: '#4f9dca', trackCaption: '#d946ef',
  clipVideo: '#6441a5', clipAudio: '#3d7ea6', clipMg: '#a83d98', clipText: '#8f5bc2',
};
...
export const SKINS: readonly SkinDef[] = [
  { id: 'graphite', nameZh: 'Kaka Roxo', tokens: GRAPHITE },
  {
