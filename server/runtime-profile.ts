...
export function resolveRuntimeProfile(
  ...
  if (profileId) {
    ...
    const rootDir = dataDir ?? join(home, '.editor-documental', 'dev-profiles', profileId);
  ...
  const rootDir = dataDir ?? join(home, '.editor-documental');
...
export function defaultRootDir(
  ...
  return isIsolatedDevProfile(profile)
    ? join(home, '.editor-documental', 'dev-profiles', profile.id)
    : join(home, '.editor-documental');
}
