...
export default {
  appId: 'com.kakastudio.kakacut',
  productName: 'Kaka Cut',
  ...
  compression: 'maximum',
  // This fork deliberately does not install upstream OpenChatCut binaries over
  // the customized application. Updates are validated and merged manually.
  publish: [],
  files: [
